 ...
 */
const { MismatchedPasswords, WrongCode, Verified, ReferralOtherRequired } = composeStories(stories)
...
describe('Sign-up stories: play (#77)', () => {
  ...
  it('ReferralOtherRequired: play runs to completion (#82)', async () => {
    const { canvas } = await runStoryPlay(ReferralOtherRequired)
