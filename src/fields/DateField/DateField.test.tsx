 ...
 */
describe('DateField helper-text role cannot be displaced by a consumer (#127)', () => {
  ...
  it('keeps the input id and the helper-text id distinct', async () => {
    ...
    const input = hiddenInput('birthday')
    ...
    expect(screen.getByRole('group', { name: 'Birthday' })).toHaveAttribute(
      'aria-describedby',
      helper.id,
    )
  })
