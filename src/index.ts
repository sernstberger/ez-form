...
// own and this export can go. `VariantInput` / `PickersVariantInput` stay internal:
// a consumer reaches the same behaviour through `slots.input`, which every field
// spreads after the shim's own.
